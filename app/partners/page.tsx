        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-3 gap-3">
              {['#C15A3A','#5A5E68','#5BA4B4','#A89870','#D4A84B','#4A4848'].map((color, i) => (
                <div
                  key={i}
      ...
      <section className="py-20 px-4 sm:px-8 bg-brand-cream">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-16 space-y-3">
            <p className="text-xs uppercase tracking-widest text-brand-muted font-medium">the process</p>
      ...
      <section id="apply" className="py-20 px-4 sm:px-8 bg-brand-cream">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-12 space-y-3">
            <p className="text-xs uppercase tracking-widest text-brand-muted font-medium">apply</p>
