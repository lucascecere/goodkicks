...
export const metadata: Metadata = {
  ...
  description:
    'Hand-stitched foot bags — what everyone calls hacky sacks — built for dorm circles, campus quads, and every backpack that needs one. $18. Free shipping on orders $30+.',
};
